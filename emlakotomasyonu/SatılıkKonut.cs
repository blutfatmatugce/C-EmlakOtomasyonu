...
{
    public partial class skonut : Form
    {
        public skonut()
        {
            InitializeComponent();
        ...
        private void skonut_Load(object sender, EventArgs e)
        {
        ...
        DataTable refresh()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from Skonut ", baglanti.pcbaglanti());
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtiskan.Text = dataGridView1.CurrentRow.Cells[16].Value.ToString();
            textyas.Text = dataGridView1.CurrentRow.Cells[17].Value.ToString();
            txtkat.Text = dataGridView1.CurrentRow.Cells[18].Value.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "Insert into Skonut (İlanBaşlığı,Fiyat,KrediUygunluk,EmlakTipi,Metrekare,OdaSalon,il,ilçe,Adres,EklemeTarihi,KullanımDurumu,Açıklama,AdSoyad,Telefon,Notlar,İskanDurumu,BinaYaşı,BinadakiKatSayısı) values(@k2,@k3,@k4,@k5,@k6,@k7,@k8,@k9,@k10,@k11,@k12,@k13,@k14,@k15,@k16,@k17,@k18,@k19)";
            ...
            komut.Parameters.AddWithValue("@k17", txtiskan.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand();
            komut.Connection = baglanti.pcbaglanti();
            komut.CommandText = "Update Skonut Set İlanBaşlığı=@k2,Fiyat=@k3,KrediUygunluk=@k4,EmlakTipi=@k5,Metrekare=@k6,OdaSalon=@k7,il=@k8,ilçe=@k9,Adres=@k10,EklemeTarihi=@k11,KullanımDurumu=@k12,Açıklama=@k13,AdSoyad=@k14,Telefon=@k15,Notlar=@k16,İskanDurumu=@k17,BinaYaşı=@k18,BinadakiKatSayısı=@k19  ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            SqlCommand komut = new SqlCommand();
            komut.Connection = baglanti.pcbaglanti();
            komut.CommandText = "Delete Skonut Where ID=@ID";
